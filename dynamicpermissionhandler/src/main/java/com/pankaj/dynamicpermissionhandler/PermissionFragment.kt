package com.pankaj.dynamicpermissionhandler
...
class PermissionFragment : androidx.fragment.app.Fragment() {
    ...
    private inner class PermissionLifecycle : LifecycleObserver {
         ...
         */
        private fun askForPermissions(it: androidx.fragment.app.FragmentActivity) {
...
fun androidx.fragment.app.FragmentManager.askPermissions(permissionRequired: Array<String>, permissionCallback: Any) {
